    ...
    <View style={[styles.container]}>
        ...
        <View style={styles.rowCenter}>
          {leftIcon && (
            <TouchableOpacity style={[styles.goBack]} >
                <Image style={styles.goBack1} source={appIcons.arrowback} onPress={() => navigation.goBack()} />
            </TouchableOpacity>
          )}
        </View>
        <View style={styles.searchbar}>{ SearchBar &&
         <GooglePlacesAutocomplete
               ...
               renderLeftButton={() =>  <Image style={styles.iconStyle} source={appIcons.Search} width={2} height={52} backgroundColor={'reds'}/>}
